...
> Phase 8.5 (技能市场) 之后的扩展

- `AgentInfo` / `AgentDetail` 新增 `skills: Vec<String>`
- 创建/编辑 Agent 弹窗增加「市场技能」checkbox 列表
- 技能卡片点击打开详情弹窗，市场技能可卸载（3s 确认）
- 卸载时级联清理所有 Agent 的 skills 引用
- 详情按钮移除，点击卡片即打开详情

### 提交记录
- `b377e04` feat: Phase 8.6 — agent skill config
- `98a8f5c` fix: remove 详情 button
- `ca6b9a8` fix: literal \n + gap

---

> **下一阶段**: [Phase 9: 平台接入](./phase9_channels.md) — 微信 + 飞书扫码绑定
